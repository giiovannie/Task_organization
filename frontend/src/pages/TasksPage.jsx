    ...
    <>
      ...
      <div className="row g-4">
        ...
        <div className="col-12 col-xl-4"><div className="card border-0 sticky-xl-top form-card"><div className="card-body p-4"><h2 className="h5 mb-3">{editingId ? 'Editar tarea' : 'Nueva tarea'}</h2><form onSubmit={submit}>
          ...
          <label className="form-label">Descripción</label><textarea className="form-control mb-3" rows="3" value={form.description} onChange={(event) => setForm({ ...form, description: event.target.value })} />
          ...
          <label className="form-label">Fecha de entrega *</label><input className="form-control mb-3" type="date" value={form.due_date} onChange={(event) => setForm({ ...form, due_date: event.target.value })} />
