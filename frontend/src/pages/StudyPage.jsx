    ...
    <>
      ...
      <div className="row g-4">
        ...
        <div className="col-12 col-lg-5"><div className="card border-0"><div className="card-body p-4"><h2 className="h5 mb-3">Nueva actividad</h2><form onSubmit={submit}>
          <label className="form-label">Actividad</label><input className="form-control mb-3" value={form.title} onChange={(event) => setForm({ ...form, title: event.target.value })} placeholder="Ej. Repasar normalización" />
          ...
          <label className="form-label">Fecha objetivo</label><input className="form-control mb-3" type="date" value={form.target_date} onChange={(event) => setForm({ ...form, target_date: event.target.value })} />
