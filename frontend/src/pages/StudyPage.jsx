...
const StudyPage = () => {
  ...
  const submit = async (event) => {
    ...
    if (!await addItem('activities', { ...form, subject_id: Number(form.subject_id), status: 'pending' })) return
